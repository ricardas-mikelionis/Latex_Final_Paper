...
Rezultatai apskaičiuojami keletu formulių:
\begin{description} 
...
Sprenimo medžiu paremtas prediktyvus modelis daug nežada. Su CM1 duomenų rinkiniu turime didelį, bet toli gražu ne patį geriausią accuracy, o visais atvejais tiek precision tiek recall reikšmės nesiekė 50\%. Galima būtų kelti hipotezę, jog didžiausią problemą sukelia duomenų rinkiniai turintys 21 atributą ir labai nelygų duomenų pasiskirstymą. Tačiau pirmiausia reikėtų patikrinti ar su tokiais pat, ne modifikuotais duomenimis galima hauti gerensius rezultatus naudojant kitokį klasifikatorių.
